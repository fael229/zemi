...
class ToutesAttributionsWidget extends StatefulWidget {
  const ToutesAttributionsWidget({Key? key}) : super(key: key);

  @override
  _ToutesAttributionsWidgetState createState() =>
      _ToutesAttributionsWidgetState();
}

class _ToutesAttributionsWidgetState extends State<ToutesAttributionsWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ToutesAttributions'});
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            stream:
                                                                              ...
                                                                              queryBuilder: (precommandeRecord) => precommandeRecord.where('statut', isEqualTo: 'Payé').where('livrer', isEqualTo: false).where('attribution', isEqualTo: true).where('livrer', isEqualTo: false).orderBy('dateAjout', descending: true),
                                                                            ),
                                                                            builder:
                                                                                (context, snapshot) {
                                                                              // Customize what your widget looks like when it's loading.
