                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: ClipRect(
                                        child: Signature(
                                          controller: signature1Controller,
                                                                                ...
                                                                                child: Column(
                                                                                  ...
                                                                                  children: [
                                                                                    Padding(
                                                                                      ...
                                                                                      child: ClipRect(
                                                                                        child: Signature(
                                                                                          controller: signature122Controller,
                                                                                          backgroundColor: Colors.white,
                                                                                          height: 320,
                                                                                        ),
                                                                                      ),
                                                                                            ...
                                                                                            child: Padding(
                                                                                              ...
                                                                                              child: StreamBuilder<List<FraisLivraisonRecord>>(
                                                                                                ...
                                                                                                builder: (context, snapshot) {
                                                                                                  ...
                                                                                                  return FFButtonWidget(
                                                                                                    onPressed: () async {
                                                                                                      final signatureImage = await signature122Controller.toPngBytes();
                                                                                                      ...
                                                                                                      if (downloadUrl != null) {
                                                                                                        setState(() => uploadedSignatureUrl2 = downloadUrl);
                                                                                                        showUploadMessage(
                                                                                                          context,
                                                                                                          'Success!',
                                                                                                        );
                                                                                                      ...
                                                                                                      final precommandeUpdateData = createPrecommandeRecordData(
                                                                                                        signature: uploadedSignatureUrl2,
                                                                                                        livrer: true,
