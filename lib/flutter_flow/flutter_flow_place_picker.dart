...
class _FFPlacePickerState extends State<FlutterFlowPlacePicker> {
  ...
  Widget build(BuildContext context) => FFButtonWidget(
        ...
        onPressed: () async {
          final p = await PlacesAutocomplete.show(
            ...
            //proxyBaseUrl: 'https://agile-ridge-02432.herokuapp.com/https://maps.googleapis.com/maps/api/',
          );
  ...
  Future displayPrediction(Prediction? p) async {
    ...
    GoogleMapsPlaces _places = GoogleMapsPlaces(
      ...
      //baseUrl: 'https://agile-ridge-02432.herokuapp.com/https://maps.googleapis.com/maps/api/',
