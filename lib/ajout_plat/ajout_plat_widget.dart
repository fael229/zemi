...
class AjoutPlatWidget extends StatefulWidget {
  const AjoutPlatWidget({Key? key}) : super(key: key);

  @override
  _AjoutPlatWidgetState createState() => _AjoutPlatWidgetState();
}

class _AjoutPlatWidgetState extends State<AjoutPlatWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'AjoutPlat'});
