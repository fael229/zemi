...
class PourVousWidget extends StatefulWidget {
  const PourVousWidget({Key? key}) : super(key: key);

  @override
  _PourVousWidgetState createState() => _PourVousWidgetState();
}

class _PourVousWidgetState extends State<PourVousWidget> {
  ...
  void initState() {
    super.initState();
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'pourVous'});
                  ...
                  child: StreamBuilder<List<ProduitsRecord>>(
                    stream: queryProduitsRecord(
                      queryBuilder: (produitsRecord) => produitsRecord
                          .where('category', isNotEqualTo: 'Ravitaillement'),
                    ),
