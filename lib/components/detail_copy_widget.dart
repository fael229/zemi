...
class DetailCopyWidget extends StatefulWidget {
  const DetailCopyWidget({
    Key? key,
    this.prodRef,
  }) : super(key: key);
  ...
  @override
  _DetailCopyWidgetState createState() => _DetailCopyWidgetState();
}

class _DetailCopyWidgetState extends State<DetailCopyWidget> {
  FavRecord? ref;
