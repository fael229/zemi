                                                                                                                            ...
                                                                                                                            mt: functions.reduce(
                                                                                                                                functions.multippl(() {
                                                                                                                                  if (rowPanierRecord.type == 'simple') {
                                                                                                                                    return rowProduitsRecord.prix!;
                                                                                                                                  } else if (rowPanierRecord.type == 'plat complet') {
                                                                                                                                    return rowProduitsRecord.prixComplet!;
                                                                                                                                  } else {
                                                                                                                                    return rowProduitsRecord.prixDemi!;
                                                                                                                                  }
                                                                                                                                }(), functions.addqty(rowPanierRecord.qty!, -1)),
                                                                                                                                rowProduitsRecord.pourcentage!),
                                                                                                                          ),
                                                                            ...
                                                                            builder:
                                                                              ...
                                                                              return FFButtonWidget(
                                                                                onPressed: () async {
                                                                                  ...
                                                                                  precommande = PrecommandeRecord.getDocumentFromData(precommandeCreateData, precommandeRecordReference);
                                                                                  FFAppState().update(() {
                                                                                    FFAppState().refPrep = precommande!.reference;
                                                                                  });
                                                                                ...
                                                                                options: FFButtonOptions(
                                                                                  width: 120,
                                                                                  height: 40,
                                                                                  color: datePicked1 == null ? Color(0xFFB8B4B4) : FlutterFlowTheme.of(context).primaryColor,
                                                                                  textStyle: FlutterFlowTheme.of(context).subtitle2.override(
                                                                                        fontFamily: 'sf pro text',
                                                                                        color: Colors.white,
                                                                                        fontSize: 14,
                                                                        ...
                                                                        child: StreamBuilder<
                                                                          ...
                                                                          stream:
                                                                            ...
                                                                            queryBuilder: (panierRecord) =>
                                                                                panierRecord.whereIn('ref', columnPrecommandeRecord.listecom!.toList()),
                                                                            singleRecord:
                                                                                true,
                                                                          ),
                                                                          builder:
                                                                                                                  ...
                                                                                                                  builder: (context, snapshot) {
                                                                                                                    ...
                                                                                                                    return FFButtonWidget(
                                                                                                                      onPressed: () async {
                                                                                                                        ...
                                                                                                                        var precommandeRecordReference = PrecommandeRecord.collection.doc();
                                                                                                                        await precommandeRecordReference.set(precommandeCreateData);
                                                                                                                        precommande2 = PrecommandeRecord.getDocumentFromData(precommandeCreateData, precommandeRecordReference);
                                                                                                                        FFAppState().update(() {
                                                                                                                          FFAppState().refPrep = precommande2!.reference;
                                                                                                                        });
                                                                                                                      ...
                                                                                                                      options: FFButtonOptions(
                                                                                                                        width: 130,
                                                                                                                        height: 40,
                                                                                                                        color: datePicked2 == null ? Color(0xFFB0AFAF) : FlutterFlowTheme.of(context).primaryColor,
                                                                                                                        textStyle: FlutterFlowTheme.of(context).subtitle2.override(
                                                                                                                              fontFamily: 'sf pro text',
                                                                                                                              color: Colors.white,
                                                                                                                              fontSize: 18,
